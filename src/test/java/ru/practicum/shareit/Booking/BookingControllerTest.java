...
public class BookingControllerTest {
    ...
    void getBookingByIdIfEverythingOk() throws Exception {
        ...
        when(bookingService.findAllBookingByUserId(anyLong(), anyString(), any(), any())).thenReturn(bookings);
    ...
    void getBookingByIdIfBadRequest() throws Exception {
        ...
        when(bookingService.findAllBookingByUserId(anyLong(), anyString(), any(), any())).thenThrow(BadRequestException.class);
    ...
    void getBookingByIdIfServerError() throws Exception {
        ...
        when(bookingService.findAllBookingByUserId(anyLong(), anyString(), any(), any())).thenThrow(NoSuchElementException.class);
    ...
    void getBookingByOwnerIfEverythingOk() throws Exception {
        ...
        when(bookingService.findAllBookingForAllItems(anyLong(), anyString(), any(), any())).thenReturn(bookings);
    ...
    void getBookingByOwnerIfBadRequest() throws Exception {
        ...
        when(bookingService.findAllBookingForAllItems(anyLong(), anyString(), any(), any())).thenThrow(BadRequestException.class);
    ...
    void getBookingByOwnerIfNoSuchElement() throws Exception {
        ...
        when(bookingService.findAllBookingForAllItems(anyLong(), anyString(), any(), any())).thenThrow(UnsupportedStatusException.class);
